(() => {
  ...
  const files=['core.js','sync.js','engine.js','schedule-guard.js','session.js','reviews.js','edital.js','assistant.js','courses.js','billing.js'];
  ...
  let tries=0;const wait=()=>{if(window.supabase){load(0);return}if(++tries<100)setTimeout(wait,100)};wait();
})();